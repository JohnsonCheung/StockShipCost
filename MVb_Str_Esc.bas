...
If InStr(A, ToStr) > 0 Then
    FunMsgAp_XDmp_Ly CSub, "Warning: escaping a {Str} of {FmStrSub} to {ToSubStr} is found that {Str} contains some {ToSubStr}.  This will make the string chagned after EscUn", A, Fm, ToStr
End If
