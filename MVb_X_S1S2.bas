...
If Not Ay_IsEqSz(A, B) Then Stop: Exit Function
Dim X, J&
...
For Each K In A.Keys
    PushObj DicS1S2Ay, S1S2(K, Var_Lines(A(K)))
Next
End Function
...
S1S2Lin = XAlignL(A.S1, W1) & Sep & A.S2
End Function

Function S1S2Ay_XAdd_AsLy(A() As S1S2, Optional Sep$ = "") As String()
Dim O$(), J&
For J = 0 To UB(A)
